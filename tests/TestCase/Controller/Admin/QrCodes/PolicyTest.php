...
class PolicyTest extends BaseControllerTest
{
    ...
    {
        // not logged in
        $this->get('http://localhost:8080/admin/qr-codes/dontexist');
    ...
    public function testIndexDebugOn(): void
    {
        ...
        $this->assertRedirectEquals('/users/login?redirect=%2Fadmin%2Fqr-codes');
    ...
    public function testViewDebugOn(): void
    {
        ...
        $this->assertRedirectEquals('/users/login?redirect=%2Fadmin%2Fqr-codes%2Fview%2F1');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
        ...
        // not logged in
        $this->loginGuest();
        $this->get('http://localhost:8080/admin/qr-codes/view');
        $this->assertResponseCode(404);
    ...
    public function testAddDebugOn(): void
    {
        ...
        $this->assertRedirectEquals('/users/login?redirect=%2Fadmin%2Fqr-codes%2Fadd');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
    ...
    public function testEditDebugOn(): void
    {
        ...
        $this->assertRedirectEquals('/users/login?redirect=%2Fadmin%2Fqr-codes%2Fedit%2F1');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
        ...
        $this->loginUserRegular();
        $this->get('http://localhost:8080/admin/qr-codes/edit/1');
        $this->assertRedirectEquals('/admin?redirect=%2Fadmin%2Fqr-codes%2Fedit%2F1');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
        ...
        $this->loginUserRegular();
        $this->get('http://localhost:8080/admin/qr-codes/edit/4');
        $this->assertResponseOk();
        ...
        // not logged in
        $this->loginGuest();
        $this->get('http://localhost:8080/admin/qr-codes/edit');
        $this->assertResponseCode(404);
        $this->assertResponseContains('Unknown ID');
    ...
    public function testDeleteDebugOn(): void
    {
        ...
        // not logged
        $this->loginGuest();
        $this->delete('http://localhost:8080/admin/qr-codes/delete/3');
        ...
        // not logged in
        $this->loginGuest();
        $this->delete('http://localhost:8080/admin/qr-codes/delete');
        $this->assertResponseCode(404);
        $this->assertResponseContains('Unknown ID');
