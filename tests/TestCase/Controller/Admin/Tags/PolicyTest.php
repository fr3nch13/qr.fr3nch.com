...
class PolicyTest extends BaseControllerTest
{
    ...
    public function testView(): void
    {
        ...
        $this->assertRedirectEquals('https://localhost/users/login?redirect=%2Fadmin%2Ftags%2Fview%2F1');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
        ...
        $this->loginUserRegular();
        $this->get('https://localhost/admin/tags/view/1');
        $this->assertRedirectEquals('https://localhost/admin?redirect=%2Fadmin%2Ftags%2Fview%2F1');
        // from \App\Middleware\UnauthorizedHandler\CustomRedirectHandler
        $this->assertFlashMessage('You are not authorized to access that location', 'flash');
        $this->assertFlashElement('flash/error');
        ...
        // not logged in
        $this->loginGuest();
        $this->get('https://localhost/admin/tags/view');
        $this->assertResponseCode(404);
