...
class CrudTest extends BaseControllerTest
{
    ...
    public function testQrCode(): void
    {
        ...
        // post
        $this->post('http://localhost:8080/admin/qr-images/qr-code/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // patch
        $this->patch('http://localhost:8080/admin/qr-images/qr-code/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // put
        $this->put('http://localhost:8080/admin/qr-images/qr-code/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // delete
        $this->delete('http://localhost:8080/admin/qr-images/qr-code/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');
    }
    ...
    public function testAdd(): void
    {
        ...
        // patch
        $this->patch('http://localhost:8080/admin/qr-images/add/1', [
        ]);
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // put
        $this->put('http://localhost:8080/admin/qr-images/add/1', [
        ]);
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // delete
        $this->delete('http://localhost:8080/admin/qr-images/add/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');
    }
    ...
    {
        // test get
        $this->get('http://localhost:8080/admin/qr-images/edit/2');
        $this->assertResponseOk();
        $this->helperTestTemplate('Admin/QrImages/edit');

        // post
        $this->post('http://localhost:8080/admin/qr-images/edit/2', [
            'name' => 'Edited QrImage',
        ]);
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');
        ...
        // patch
        $this->patch('http://localhost:8080/admin/qr-images/edit/2', [
            'name' => 'Edited QrImage',
        ]);
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');
        ...
        // put
        $this->put('http://localhost:8080/admin/qr-images/edit/1', [
            'name' => 'Edited QrImage',
        ]);
        ...
        // delete
        $this->delete('http://localhost:8080/admin/qr-images/edit/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');
    }
    ...
    {
        // test get
        $this->get('http://localhost:8080/admin/qr-images/delete/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // post
        $this->post('http://localhost:8080/admin/qr-images/delete/1');
        $this->assertRedirectEquals('/admin/qr-images/qr-code/1');
        $this->assertFlashMessage('The image `Front Cover` for `Sow & Scribe` has been deleted.', 'flash');
        $this->assertFlashElement('flash/success');

        // patch
        $this->patch('http://localhost:8080/admin/qr-images/delete/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // put
        $this->put('http://localhost:8080/admin/qr-images/delete/1');
        $this->assertResponseCode(405);
        $this->assertResponseContains('Method Not Allowed');

        // delete
        $this->delete('http://localhost:8080/admin/qr-images/delete/2');
        $this->assertRedirectEquals('/admin/qr-images/qr-code/1');
